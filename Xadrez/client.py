...
def redrawWindow(win, game, p):
    ...
    if not(game.connected()):
        ...
        text = font.render("Esperando jogador...", 1, (255,0,0), True)
        ...
        if game.bothWent():
            ...
            if game.p1Went and p == 0:
                ...
                text1 = font.render("Encerrado", 1, (0, 0, 0))
            else:
            ...
            if game.p2Went and p == 1:
                ...
                text2 = font.render("Encerrado", 1, (0, 0, 0))
            else:
...
def main():
    ...
    while run:
        ...
        try:
            ...
            run = False
            print("não foi possivel entrar no jogo")
            break
...
def menu_screen():
    ...
    while run:
        ...
        win.fill((128, 128, 128))
        font = pygame.font.SysFont("comicsans", 60)
        text = font.render("Pressione para jogar!", 1, (255,0,0))
